...
wine <- wine %>% 
  mutate(description = paste0(description, " colour_", colour))
...
<center>
<img src="https://raw.githubusercontent.com/marcotcr/lime/master/doc/images/lime.png" alt="LIME" style="width: 65%; height: 65%;"></img>
</center>
...
wine_a <- filter(wine, index == 14072)
wine_a_explanation <- lime::explain(
  wine_a$description,
  wine_explainer,
  n_features = 10
)
...
```{r wine_b_explanation_plot, eval=FALSE}
custom_lime_explanation_plot(
