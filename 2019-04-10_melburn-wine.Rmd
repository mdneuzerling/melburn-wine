...
.pull-left[
```{r xgb_explanation, results='asis'}
sample_wine <- wine %>% 
  filter(index == 71573)
...
.pull-right[
```{r xgb_explanation_plot, echo=FALSE, dpi = 300, fig.width = 5, fig.height = 5, out.height = 500, out.width = 500}
sample_wine_explanation %>% 
  ...
  labs(
    title = paste0(
      sample_wine$variety,
      ", ", sample_wine$country,
      ", ", sample_wine$points, " points"
    ),
    subtitle = paste0(
      "predicted: ", 
      round(min(sample_wine_explanation$model_prediction), 1),
      " points"
    ),
    x = "feature",
    y = ""
