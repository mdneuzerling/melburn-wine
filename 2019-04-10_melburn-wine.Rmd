...
```{r xgb_explanation}
sample_wine <- filter(wine, index == 71573)
...
```{r sample_wine_explanation_plot, eval=FALSE}
...
.pull-right[
```{r sample_wine_explanation_plot_out, ref.label="sample_wine_explanation_plot", echo=FALSE, dpi = 300, fig.width = 5, fig.height = 5, out.height = 500, out.width = 500}
